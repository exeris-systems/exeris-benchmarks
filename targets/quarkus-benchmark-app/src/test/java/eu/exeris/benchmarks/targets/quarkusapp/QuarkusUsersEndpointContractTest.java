package eu.exeris.benchmarks.targets.quarkusapp;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import eu.exeris.benchmarks.targets.quarkusapp.controller.UserResource;
...
class QuarkusUsersEndpointContractTest {
    ...
    void endpointPayloadKeepsShapeCardinalityOrderingAndDeterminism() throws Exception {
        ...
        setField(service, "userRepository", repository);

        UserResource resource = new UserResource();
        setField(resource, "userService", service);

        String first = objectMapper.writeValueAsString(resource.readUsers());
        String second = objectMapper.writeValueAsString(resource.readUsers());
    ...
    private static final class StubUserRepository extends UserRepository {
        ...
        public List<UserView> findTopUsersWithDetails(int userLimit, int friendLimit, int interestLimit) {
            return fixtureUsersWithDetails(userLimit);
        }
    }
}
